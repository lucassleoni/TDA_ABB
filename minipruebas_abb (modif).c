...
/*
void imprimir_arbol_entero(){
    printf("\t\t%i\n", *(int*)arbol->nodo_raiz->elemento);
    printf("\t%i", *(int*)arbol->nodo_raiz->izquierda->elemento);
    printf("\t\t%i\n", *(int*)arbol->nodo_raiz->derecha->elemento);
    printf("    %i", *(int*)arbol->nodo_raiz->izquierda->izquierda->elemento);
    printf("       %i", *(int*)arbol->nodo_raiz->izquierda->derecha->elemento);
    printf("       %i\n", *(int*)arbol->nodo_raiz->derecha->izquierda->elemento);
    printf("       %i\n", *(int*)arbol->nodo_raiz->derecha->derecha->elemento);
}
*/
